...
const formSchema = z
  .object({
    ...
    speciality: z
      .string()
      .trim()
      .min(1, { message: "Especilidade é obrigatório" }),
    appointmentPrice: z
      .number()
            ...
            render={({ field }) => (
              <FormItem>
                ...
                >
                  ...
                  <SelectContent>
                    <SelectGroup>
                      <SelectLabel className="font-bold">Manhã</SelectLabel>
                    ...
                    <SelectGroup>
                      <SelectLabel className="font-bold">Tarde</SelectLabel>
                    ...
                    <SelectGroup>
                      <SelectLabel className="font-bold">Noite</SelectLabel>
